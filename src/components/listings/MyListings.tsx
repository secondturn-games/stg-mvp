  ...
  if (listings.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600 mb-4">Create your first listing to start selling games!</p>
        <a 
        ...
        <div key={listing.id} className="bg-white rounded-lg shadow border p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 text-sm">
            <div>
              ...
              <p className="text-gray-600">{getConditionLabel(listing.condition)}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600 font-mono text-xs">{listing.id.slice(0, 8)}...</p>
            </div>
          </div>
