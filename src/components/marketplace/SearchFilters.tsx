...
export default function SearchFilters({ onSearchChange, onFiltersChange, onSortChange }: SearchFiltersProps) {
    ...
    <div className="space-y-4">
      ...
      {showFilters && (
        <div className="bg-gray-50 rounded-lg p-4 space-y-4">
          ...
          {/* Price Range Filter */}
          <div>
            <h4 className="text-sm font-medium text-gray-700 mb-2">Price Range (EUR)</h4>
            <div className="grid grid-cols-2 gap-2">
              <div>
