...
export default function DeleteConfirmation({ itemId, itemType, itemName }: DeleteConfirmationProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      const endpoint = itemType === 'listing' ? `/api/listings/${itemId}` : `/api/auctions/${itemId}`
