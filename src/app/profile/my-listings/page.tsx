...
export default async function MyListingsPage() {
  ...
  const formattedAuctions =
    auctions?.map(auction => ({
      ...
      formattedBuyNowPrice: auction.buy_now_price
        ? formatCurrency(auction.buy_now_price, locale)
        : null,
  ...
  const allItems = [...formattedListings, ...formattedAuctions].sort(
    (a, b) =>
          ...
          {allItems.length === 0 ? (
            <div className='p-8 text-center'>
              ...
              <p className='text-gray-600 mb-4'>
                Start selling your board games by creating your first listing or
                auction.
              </p>
              <Link
                href='/listings/create'
                        ...
                        <div>
                          ...
                          {item.type === 'listing' ? (
                            ...
                            <div className='space-y-1'>
                              <p className='text-sm text-gray-600'>
                                Current: {item.formattedCurrentPrice} • Started:{' '}
                              ...
                              <div className='flex items-center space-x-2 text-xs text-gray-500'>
                                ...
                                {item.formattedBuyNowPrice && (
                                  <span>
                                    • Buy Now: {item.formattedBuyNowPrice}
                                  </span>
                                )}
                              </div>
                            </div>
